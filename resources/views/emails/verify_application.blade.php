...
@section('content')
    ...
    <p><a href="{{ route('application.verify', ['token' => $application->verification_token]) }}" style="padding: 10px 20px; margin: 10px 0; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;">Verify Email Address</a></p>
