...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .period-badge { display: inline-block; padding: 4px 12px; background: #eff6ff; color: #1e40af; border-radius: 12px; font-size: 11px; font-weight: 600; margin-bottom: 16px; }
        ...
        <div class="meta-row">
            ...
            <div class="meta-col" style="text-align: right;">
                ...
                @if($period_start && $period_end)
                    ...
                    <div class="meta-value">{{ $period_start }} — {{ $period_end }}</div>
                @endif
                @if($paid_at)
