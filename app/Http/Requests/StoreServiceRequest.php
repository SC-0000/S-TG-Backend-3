    ...
    public function authorize(): bool
{
    ...
    public function rules(): array
    {
        return [
            ...
            'selection_config.groups'               => 'nullable|array',
            'selection_config.groups.*.id'          => 'nullable|string',
            'selection_config.groups.*.name'        => 'nullable|string|max:100',
            'selection_config.groups.*.required'    => 'nullable|integer|min:1',
            'selection_config.groups.*.items'       => 'nullable|array',
            'selection_config.groups.*.items.*.id'  => 'required|integer',
            'selection_config.groups.*.items.*.type' => 'required|in:lesson,assessment',
